...
export function ConnectWallet() {
      ...
      const fetchBalance = async () => {
        try {
          ...
          const bal = await connection.getBalance(
            smartWalletPubkey as PublicKey
          );
      ...
      <>
        ...
        >
          ...
          <div className="flex flex-col -gap-0.5">
            <span className="text-gray-900 text-[10px] font-bold leading-tight uppercase tracking-widest opacity-50">
              Active Wallet
            </span>
  ...
  return (
    ...
    >
      ...
      <span>{isConnecting ? "Connecting..." : "Connect Passkey"}</span>
    </button>
  );
}
